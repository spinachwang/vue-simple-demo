      ...
      <div v-if="itemType === 'item'">
        <div class="home-back home-logo-wrap">
          <div class="item-list-wrap">
            ...
            <ol>
              <li v-for="(answer, index) in itemDetail[itemNumber-1].answer" :class="{ 'option-style': true, 'choose-option-style': answer === choosedAnswer }" @click="onChooseAnswer(answer)" :key="answer">
                {{ index+1 }}: {{ answer }}
              </li>
            </ol>
          </div>
